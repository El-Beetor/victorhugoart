...
export default function BillowingTreeBehindTheScenes() {
  const { accentColor, darkColors } = useColors();

  const colorPalette = [
    { color: '#6B8E23', name: 'Olive Green', percentage: 35 },
    { color: '#F0E68C', name: 'Yellow-Cream', percentage: 25 },
    { color: '#4A3728', name: 'Dark Brown', percentage: 18 },
    { color: '#8B7D6B', name: 'Gray-Brown', percentage: 12 },
    { color: '#654321', name: 'Dark Brown-Black', percentage: 6 },
    { color: '#E8E0D5', name: 'Light Cream', percentage: 4 },
  ];

  // Value breakdown (light to dark)
  const valueBreakdown = [
    { color: '#E6E6E6', name: 'Highlights', percentage: 18 },
    { color: '#B8B8B8', name: 'Lights', percentage: 28 },
    { color: '#787878', name: 'Midtones', percentage: 32 },
    { color: '#404040', name: 'Darks', percentage: 17 },
    { color: '#202020', name: 'Deep Shadows', percentage: 5 },
  ];
      ...
      <main className="pt-24 pb-16 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="text-center mb-12">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4" style={{ color: darkColors[0] || accentColor }}>Billowing Tree</h1>
