...
export default function SistersBehindTheScenes() {
  const { accentColor, darkColors } = useColors();

  const colorPalette = [
    { color: '#4A5D3F', name: 'Dark Olive', percentage: 38 },
    { color: '#B0A896', name: 'Gray-Brown', percentage: 22 },
    { color: '#E8DCC8', name: 'Cream White', percentage: 20 },
    { color: '#6B7C6E', name: 'Olive Green', percentage: 12 },
    { color: '#D4C5A0', name: 'Warm Beige', percentage: 5 },
    { color: '#2C3E2F', name: 'Dark Green', percentage: 3 },
  ];

  // Value breakdown (light to dark)
  const valueBreakdown = [
    { color: '#E2E2E2', name: 'Highlights', percentage: 10 },
    { color: '#B2B2B2', name: 'Lights', percentage: 15 },
    { color: '#707070', name: 'Midtones', percentage: 35 },
    { color: '#404040', name: 'Darks', percentage: 30 },
    { color: '#1A1A1A', name: 'Deep Shadows', percentage: 10 },
  ];
      ...
      <main className="pt-24 pb-16 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="text-center mb-12">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4" style={{ color: darkColors[0] || accentColor }}>Sisters</h1>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="mb-16">
            <div className="relative max-w-3xl mx-auto bg-[#fffff7] p-6 sm:p-8 shadow-2xl">
              <Image src="/FinishedPaintings/duck.jpg" alt="Sisters - Finished Painting" width={1200} height={800} className="w-full h-auto" />
              <div className="mt-6 text-center">
                <h2 className="text-2xl font-bold mb-2" style={{ color: darkColors[0] || accentColor }}>Finished Painting</h2>
                <p className="text-sm" style={{ color: darkColors[1] || accentColor }}>Oil on Paper 8&quot; x 10&quot; • 2025</p>
              </div>
            </div>
          </motion.div>
